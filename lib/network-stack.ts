...
export class NetworkStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        this.appSg.addIngressRule(this.appSg, Port.tcp(80), 'allow http access from alb');
        ...
        this.dbSg.addIngressRule(this.appSg, Port.tcp(3306), 'allow db access from app server');
